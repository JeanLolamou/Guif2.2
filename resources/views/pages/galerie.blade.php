@extends('templates/default',['title'=>'GUIF | GALERIE'])
    ...
    <div class='list-group gallery'>
       <?php for ($i=1; $i <=31 ; $i++) : ?>
            <div class='col-sm-4 col-xs-6 col-md-4 col-lg-4'>
                <a class="thumbnail fancybox" rel="ligthbox" href="images/Guif2/album2/<?php echo $i; ?>.jpg">
                    <img class="img-responsive" alt="" src="images/Guif2/album2/<?php echo $i; ?>.jpg" style="height: 200px;" />
