@extends('templates/default',['title'=>'GUIF | INSCRIPTION-PARTENAIRE'])
  ...
  <div class="container">
    <div class="row" style="" >
      ...
      <div class="" style="    width: 100%;text-align: center;padding: 10px;background: #da7408;color: white;">
       <h4 style="color: #fff;font-weight: bold;text-transform: uppercase;">Devenir partenaire</h4>
      </div>
      ...
      <div class="form-field col-lg-6">
         ...
         <label class="label" for="name">Prénom, Nom</label>
      </div>
      <div class="form-field col-lg-6 ">
