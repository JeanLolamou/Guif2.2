  ...
  <ul>
    ...
    <form action="{{route('ajoutParticipantGuif')}}" method="POST" enctype="multipart/form-data">
      ...
      <fieldset>
        ...
        <input type="hidden" name="userType" value="Officielle">
        ...
        <div class="row" style="box-shadow: 0 0 4px #ccc;padding: 10px;">
            <div class="col-md-4">
               ...
               @endif
                    ...
                    <select name="categorie" required="required" class="form-control" placeholder="Categorie">
                    

                     @if (old('categorie')=="Gouvernement")
                     <option value="Gouvernement" selected>Gouvernement</option>
                    @else
                     <option value="Gouvernement">Gouvernement</option>
                    @endif

                     @if (old('categorie')=="representation-diplomatique")
                     <option value="representation-diplomatique" selected>Représentation diplomatique </option>
                    @else
                     <option value="representation-diplomatique">Représentation diplomatique</option>
                    @endif

                      @if (old('categorie')=="institution-internationale")
                     <option value="institution-internationale" selected>Institution internationale </option>
                    @else
                     <option value="institution-internationale">Institution internationale</option>
                    @endif

                    @if (old('categorie')=="Autres")
                    ...
                    @if($errors->has('categorie'))
                     <div class="error">{{ $errors->first('categorie') }}</div>
                    @endif
            ...
            <?php endforeach ?>
               ...
               @endif
                  ...
                  <div class="col-md-12">
                     <div class="form-group">
                  <button type="submit" class="btn btn-lg btn-info" style="margin: 30px 10px;float: right;background-color: #193c7d;">Inscription</button>
                </div>
                  </div>
                  <!-- /col -->
                </div>
