...
<script src="https://cdn.ckeditor.com/4.11.3/standard/ckeditor.js"></script>
         <div class="row" style="padding-left: 10px;">
           <h2>Modification Obtention Titre Foncier</h2>
         </div>
          <div class="row" style="padding-left: 20px; padding-right: 20px;">
              @foreach ($foncier as $fonciers)
           <form action="{{ route ('Foncier.update', $fonciers->id)}}" method="post" enctype="multipart/form-data" style="width: 100%;">
                       {{ csrf_field() }}
                        {{ method_field('PUT') }}
    ...
    <div class="col-md-5">
     ...
     <div class="text-input">
          <input name="libelle" type="text" id="input1" placeholder="Entrer un nom!" value="{{ $fonciers->libelle}}" required>
  ...
  <strong>Erreur!</strong> <span class="error">:message</span>
    ...
    <div class="col-md-12">
      <div class="form-group">
      <img src="{{ asset('images/'.$fonciers->image.'')}}" alt="" style="height: 50px;"><br>
  ...
  <div class="form-group">
                ...
                <a href="{{route('adminFoncier')}}" type="button"  class="btn btn-infos">Annuler</a>
