...
input[type="checkbox"]:checked + label:before {
  ...
  <strong>Succés!</strong> {{session()->get('message')}}
          ...
          <div class="row" style="padding: 20px;">
            <br/>
             <a href="{{route('adminphotos')}}" type="button" class="btn bg-blue fs-it-btn" style="color: white;">
    ...
    <div class="col-md-3" style="margin-bottom: 5px;">
       <span>{{$photos->nom_photo}}</span>
      <img src="{{ asset('images/gallerie/'.$photos->lien.'')}}" style="width: 100%;height: 200px;" /><br>
     
       <a href="#"  data-toggle="modal" data-target="#Modal{{$photos->id_photo}}" type="button" class="btn bg-blue fs-it-btn" style="color: white;width: 100%;">
        <i class="fa fa-trash-alt" aria-hidden="true"></i>
        <span class="fs-it-btn-vertical-line">Restaurer</span>
        </a>

         <!-- Restore Modal-->
  <div class="modal fade" id="Modal{{$photos->id_photo}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Voulez-vous vraiment restaurer cette photo ?</h5>
