...
input[type="checkbox"]:checked + label:before {
  ...
  <strong>Succés!</strong> {{session()->get('message')}}
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Ajout Album</h5>
    ...
    <div class="col-md-6">
     ...
     <div class="text-input">
        <input name="libelleFr" type="text" id="input1" placeholder="Entrer un nom!" value="{{ old('libelleFr') }}" required="">
  ...
  <div class="form-group">
   ...
   <div class="form-group">
     <div class="text-input">
        ...
        <div class="modal-footer">
         <div class="form-group">
                ...
                <a href="{{route('admingalerie')}}" type="button"  class="btn btn-danger" >Annuler</a>
            </div>  
        </div>
        </form> 
      </div>
             ...
             <div class="col-md-3">
               <a href="{{route('corbeilleGalerie')}}" type="button" class="btn bg-blue fs-it-btn" style="color: white;">
    ...
    <div class="col-md-3" style="margin-bottom: 5px;">
       <span>{{$photos->libelleFr}}</span>
      <img src="{{ asset('images/gallerie/'.$photos->image.'')}}" style="width: 100%;height: 200px;" /><br>
  ...
  <div class="modal fade" id="deleteModal{{$photos->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Voulez-vous vraiment supprimer cet album?</h5>
          <button class="close" type="button" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">×</span>
          </button>
        </div>
        ...
        <div class="modal-footer">
           <form action="{{ route ('Gallerie.update', $photos->id)}}" method="post" >
               {{ csrf_field() }}
              {{ method_field('PUT') }}
