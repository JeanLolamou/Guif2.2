...
<script src="https://cdn.ckeditor.com/4.11.3/standard/ckeditor.js"></script>
         <div class="row" style="padding-left: 10px;">
           <h2>Modification meuble</h2>
         </div>
          <div class="row" style="padding-left: 20px; padding-right: 20px;">
              @foreach ($meuble as $meubles)
           <form action="{{ route ('Meuble.update', $meubles->id)}}" method="post" enctype="multipart/form-data" style="width: 100%;">
                       {{ csrf_field() }}
                        {{ method_field('PUT') }}
    ...
    <div class="col-md-5">
     ...
     <div class="text-input">
          <input name="libelle" type="text" id="input1" placeholder="Entrer un nom!" value="{{ $meubles->libelle}}" required>
  ...
  <strong>Erreur!</strong> <span class="error">:message</span>
    ...
    <div class="col-md-5">
      <div class="form-group">
     <div class="text-input">
          <input name="prix" type="text" id="input1" placeholder="Entrer le prix!" value="{{$meubles->prix}}">
  ...
  <div class="row" style="margin-top: 15px;">
     ...
     <div class="col-md-4">
      <div class="form-group">
      <img src="{{ asset('images/'.$meubles->image.'')}}" alt="" style="height: 50px;"><br>
  ...
  <div class="form-group">
                ...
                <a href="{{route('adminMeuble')}}" type="button"  class="btn btn-infos">Annuler</a>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
           <form action="{{ route ('Meuble.update', $meubles->id)}}" method="post" >
               {{ csrf_field() }}
              {{ method_field('PUT') }}
