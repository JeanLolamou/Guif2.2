 ...
 <div class="row" style="width: 100%;padding: 20px;">
  ...
  <strong>Succés!</strong> {{session()->get('message')}}
         ...
         <div class="row" style="padding: 10px;">
           <h2>Ajout Nettoyage</h2>
         </div>
          <div class="row" style="padding-left: 20px; padding-right: 20px;">

          <form  action="{{route ('Nettoyage.store')}}" method="POST" enctype="multipart/form-data" style="width: 100%;">
                     {{ csrf_field() }}
  <div class="row">
    <div class="col-md-5">
  ...
  <div class="form-group">
                ...
                <a href="{{route('adminNettoyage')}}" type="button"  class="btn btn-danger" >Annuler</a>
            </div>  
