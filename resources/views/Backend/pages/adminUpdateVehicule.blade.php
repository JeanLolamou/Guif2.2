...
<script src="https://cdn.ckeditor.com/4.11.3/standard/ckeditor.js"></script>
         <div class="row" style="padding-left: 10px;">
          ...
          <div class="row" style="padding-left: 20px; padding-right: 20px;">
           ...
           <form action="{{ route ('Vehicule.update', $vehicules->id)}}" method="post" enctype="multipart/form-data" style="width: 100%;">
                       {{ csrf_field() }}
                        {{ method_field('PUT') }}
    ...
    <div class="col-md-5">
     ...
     <div class="text-input">
          <input name="libelle" type="text" id="input1" placeholder="Entrer un nom!" value="{{ $vehicules->libelle}}" required>
  ...
  <strong>Erreur!</strong> <span class="error">:message</span>
    ...
    <div class="col-md-5">
      <div class="form-group">
     <div class="text-input">
          <input name="prix" type="text" id="input1" placeholder="Entrer le prix!" value="{{$vehicules->prix}}">
  ...
  <div class="row" style="margin-top: 15px;">
     ...
     <div class="col-md-4">
      <div class="form-group">
      <img src="{{ asset('images/'.$vehicules->image.'')}}" alt="" style="height: 50px;"><br>
