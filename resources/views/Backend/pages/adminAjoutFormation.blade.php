 ...
 <div class="row" style="width: 100%;padding: 20px;">
  ...
  <strong>Succés!</strong> {{session()->get('message')}}
         ...
         <div class="row" style="padding: 10px;">
          ...
          <form  action="{{route ('Formation.store')}}" method="POST" enctype="multipart/form-data" style="width: 100%;">
                     {{ csrf_field() }}
  <div class="row">
    <div class="col-md-5">
  ...
  <div class="form-group">
                ...
                <a href="{{route('adminFormation')}}" type="button"  class="btn btn-danger" >Annuler</a>
            </div>  
