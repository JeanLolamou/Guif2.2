 ...
 <div class="row" style="width: 100%;padding: 20px;">
  ...
  <strong>Succés!</strong> {{session()->get('message')}}
         ...
         <div class="row" style="padding: 10px;">
          ...
          <form  action="{{route ('Terrain.store')}}" method="POST" enctype="multipart/form-data" style="width: 100%;">
                     {{ csrf_field() }}
  <div class="row">
    <div class="col-md-5">
  ...
  <strong>Erreur!</strong> <span class="error">:message</span>
      ...
      <div class="form-group">
     <div class="text-input">
          <input name="lieu" type="text" id="input1" placeholder="Entrer le lieu!" value="{{ old('lieu') }}">
  ...
  <div class="form-group">
                ...
                <a href="{{route('adminTerrain')}}" type="button"  class="btn btn-danger" >Annuler</a>
            </div>  
