...
<script src="https://cdn.ckeditor.com/4.11.3/standard/ckeditor.js"></script>
         <div class="row" style="padding-left: 10px;">
           <h2>Modification terrain</h2>
         </div>
          <div class="row" style="padding-left: 20px; padding-right: 20px;">
              @foreach ($terrain as $terrains)
           <form action="{{ route ('Terrain.update', $terrains->id)}}" method="post" enctype="multipart/form-data" style="width: 100%;">
                       {{ csrf_field() }}
                        {{ method_field('PUT') }}
    ...
    <div class="col-md-5">
     ...
     <div class="text-input">
          <input name="libelle" type="text" id="input1" placeholder="Entrer un nom!" value="{{ $terrains->libelle}}" required>
  ...
  <strong>Erreur!</strong> <span class="error">:message</span>
    ...
    <div class="col-md-5">
      <div class="form-group">
     <div class="text-input">
          <input name="prix" type="text" id="input1" placeholder="Entrer le prix!" value="{{$terrains->prix}}">
  ...
  <strong>Erreur!</strong> <span class="error">:message</span>
    ...
    <div class="col-md-5" style="margin-left: 1px;">
      <div class="form-group">
     <div class="text-input">
          <input name="surface" type="text" id="input1" placeholder="Entrer une surface!" value="{{$terrains->surface}}">
          <label for="input1">Surface</label>
          </div>
  ...
  <strong>Erreur!</strong> <span class="error">:message</span>
    ...
    <div class="col-md-5" style="margin-left: 1px;">
      <div class="form-group">
     <div class="text-input">
          <input name="lieu" type="text" id="input1" placeholder="Entrer le lieu!" value="{{$terrains->lieu}}">
          <label for="input1">Lieu</label>
          </div>
  ...
  <div class="row" style="margin-top: 15px;">
     ...
     <div class="col-md-4">
      <div class="form-group">
      <img src="{{ asset('images/'.$terrains->image.'')}}" alt="" style="height: 50px;"><br>
  ...
  <strong>Erreur!</strong> <span class="error">:message</span>
   ...
   <select name="type" style="padding: 8px;border: 2px solid #fa8072;">
      <option value="{{$terrains->type}}">{{$terrains->type}}</option>
  ...
  <div class="form-group">
                ...
                <a href="{{route('adminTerrain')}}" type="button"  class="btn btn-infos">Annuler</a>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
           <form action="{{ route ('Terrain.update', $terrains->id)}}" method="post" >
               {{ csrf_field() }}
              {{ method_field('PUT') }}
