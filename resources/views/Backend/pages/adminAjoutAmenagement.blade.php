 ...
 <div class="row" style="width: 100%;padding: 20px;">
  ...
  <strong>Succés!</strong> {{session()->get('message')}}
         ...
         <div class="row" style="padding: 10px;">
           <h2>Ajout Amenagement</h2>
         </div>
          <div class="row" style="padding-left: 20px; padding-right: 20px;">

          <form  action="{{route ('Amenagement.store')}}" method="POST" enctype="multipart/form-data" style="width: 100%;">
                     {{ csrf_field() }}
  <div class="row">
    <div class="col-md-5">
  ...
  <div class="form-group">
                ...
                <a href="{{route('adminAmenagement')}}" type="button"  class="btn btn-danger" >Annuler</a>
            </div>  
