...
<script src="https://cdn.ckeditor.com/4.11.3/standard/ckeditor.js"></script>
         <div class="row" style="padding-left: 10px;">
           <h2>Modification construction</h2>
         </div>
          <div class="row" style="padding-left: 20px; padding-right: 20px;">
              @foreach ($construction as $constructions)
           <form action="{{ route ('Construction.update', $constructions->id)}}" method="post" enctype="multipart/form-data" style="width: 100%;">
                       {{ csrf_field() }}
                        {{ method_field('PUT') }}
    ...
    <div class="col-md-5">
     ...
     <div class="text-input">
          <input name="libelle" type="text" id="input1" placeholder="Entrer un nom!" value="{{ $constructions->libelle}}" required>
  ...
  <strong>Erreur!</strong> <span class="error">:message</span>
    ...
    <div class="col-md-12">
      <div class="form-group">
      <img src="{{ asset('images/'.$constructions->image.'')}}" alt="" style="height: 50px;"><br>
  ...
  <div class="form-group">
                ...
                <a href="{{route('adminConstruction')}}" type="button"  class="btn btn-infos">Annuler</a>
